...
export const DETALLES: { [nombre: string]: DetalleEjercicio } = {
  ...
  "Press militar de pie": {
    ...
    videoUrl: "https://musclewiki.com/exercise/dumbbell-overhead-press",
  ...
  "Aperturas en banco": {
    ...
    videoUrl: "https://musclewiki.com/exercise/dumbbell-chest-fly",
  ...
  "Plancha": {
    ...
    videoUrl: "https://musclewiki.com/exercise/forearm-plank",
  ...
  "Remo a una mano en banco": {
    ...
    videoUrl: "https://musclewiki.com/exercise/dumbbell-single-arm-row",
  ...
  "Remo inclinado a dos manos": {
    ...
    videoUrl: "https://musclewiki.com/exercise/dumbbell-row-bilateral",
  ...
  "Curl de bíceps": {
    ...
    videoUrl: "https://musclewiki.com/exercise/dumbbell-curl",
  ...
  "Superman en tapete": {
    ...
    videoUrl: "https://musclewiki.com/exercise/supermans",
  ...
  "Zancadas alternadas": {
    ...
    videoUrl: "https://musclewiki.com/exercise/dumbbell-alternating-forward-lunge",
  ...
  "Fondos de tríceps en banco": {
    ...
    videoUrl: "https://musclewiki.com/exercise/bench-dips",
  ...
  "Remo renegado (plancha + remo)": {
    ...
    videoUrl: "https://musclewiki.com/exercise/dumbbell-renegade-row",
  ...
  "Russian twist": {
    ...
    videoUrl: "https://musclewiki.com/exercise/dumbbell-russian-twist",
    musculos: ["obliques", "abs"],
  },
};
